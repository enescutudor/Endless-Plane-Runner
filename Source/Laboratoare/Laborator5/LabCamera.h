	...
	class Camera
	{
		public:
			...
			void RotateFirstPerson_OY(float angle)
			{
				...
				// Use glm::rotate()
				forward = glm::normalize(rotate(glm::mat4(1), angle, right) * vec4(forward, 0));
			...
			void RotateFirstPerson_OX(float angle)
			{
				...
				// Use glm::rotate()
				right = normalize(rotate(mat4(1), angle, vec3(0,1,0)) * vec4(right, 0));
				forward = normalize(rotate(mat4(1), angle, vec3(0,1,0)) * vec4(forward, 0));
				up = normalize(rotate(mat4(1), angle, vec3(0,1,0)) * vec4(up, 0));
			...
			void RotateFirstPerson_OZ(float angle)
			{
				...
				// Don't forget to normalize the vectors
				right = normalize(rotate(mat4(1), angle, forward) * vec4(right, 0));
